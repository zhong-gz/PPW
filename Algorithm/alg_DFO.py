...
from functions import linear_data_generation2,data_distribution_map7,est_varepsilon,data_distribution_map1,data_distribution_map2,data_distribution_map3,data_distribution_map4,data_distribution_map5,remove_outliers_iqr,linear_data_generation
        ...
        for k, d in enumerate(d_list):
            ...
            for t in range(num_iters):
                ...
                if map == 6:
                    ...
                    X_strat,y_strat = data_distribution_map1(X, y,mu = d, model = model, strat_features = strat_features)
                if map == 7:
                    X_strat,y_strat = data_distribution_map7(X, y,mu = d, model = model)
